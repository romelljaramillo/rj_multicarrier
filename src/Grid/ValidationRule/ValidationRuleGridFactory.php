<?php
/**
 * Factoría del grid de reglas de validación.
 */
...
final class ValidationRuleGridFactory
{
    public function __construct(
        private readonly ValidationRuleGridDefinitionFactory $gridDefinitionFactory,
    ...
    public function getGrid(ValidationRuleFilters $filters): Grid
    {
