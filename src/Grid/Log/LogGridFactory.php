<?php
/**
 * Grid factory wrapper for carrier logs.
 */
...
final class LogGridFactory
{
    public function __construct(
        private readonly LogGridDefinitionFactory $gridDefinitionFactory,
    ...
    public function getGrid(LogFilters $filters): Grid
    {
