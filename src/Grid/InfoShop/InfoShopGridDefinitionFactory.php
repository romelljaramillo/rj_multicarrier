<?php
/**
 * Grid definition factory for InfoShop listing.
 */
...
final class InfoShopGridDefinitionFactory extends AbstractModuleGridDefinitionFactory
{
    use BulkDeleteActionTrait;
    use DeleteActionTrait;

    public const GRID_ID = 'rj_multicarrier_info_shop';
    ...
    protected function getColumns(): ColumnCollection
    {
        return (new ColumnCollection())
            ->add((new BulkActionColumn('infoshop_bulk'))
                ->setOptions([
                    'bulk_field' => 'id_infoshop',
                ]))
            ->add((new DataColumn('id_infoshop'))
            ...
            ->add((new ToggleColumn('active'))
                ...
                ->setOptions([
                    'field' => 'active',
                    'primary_field' => 'id_infoshop',
                    'route' => 'admin_rj_multicarrier_info_shop_toggle',
                    'route_param_name' => 'id',
                    'extra_route_params' => [
                        '_token' => 'toggle_token',
                    ],
    ...
    protected function getFilters(): FilterCollection
    {
        return (new FilterCollection())
            ->add((new Filter('id_infoshop', TextType::class))
                ->setAssociatedColumn('id_infoshop'))
            ...
            ->add((new Filter('actions', SearchAndResetType::class))
                ->setTypeOptions([
                    ...
                    'redirect_route' => 'admin_rj_multicarrier_info_shop_index',
                ])
    ...
    protected function getGridActions(): GridActionCollectionInterface
    {
        return (new GridActionCollection())
            ...
            ->add((new SubmitGridAction('export_csv'))
                ...
                ->setIcon('download')
                ->setOptions([
                    'submit_route' => 'admin_rj_multicarrier_info_shop_export_csv',
    ...
    protected function getBulkActions(): BulkActionCollection
    {
        ...
        $bulkActions->add((new SubmitBulkAction('export_selected_csv'))
            ...
            ->setOptions([
                'submit_route' => 'admin_rj_multicarrier_info_shop_export_selected_csv',
            ]));

        $bulkActions->add(
            $this->buildBulkDeleteAction('admin_rj_multicarrier_info_shop_delete_bulk')
        );
    ...
    private function getRowActions(): RowActionCollection
    {
        ...
        $actions->add((new LinkRowAction('edit'))
            ...
            ->setIcon('edit')
            ->setOptions([
                'route' => 'admin_rj_multicarrier_info_shop_edit',
                'route_param_name' => 'id',
                'route_param_field' => 'id_infoshop',
            ]));

        $actions->add(
            $this->buildDeleteAction(
                'admin_rj_multicarrier_info_shop_delete',
                'id',
                'id_infoshop',
                Request::METHOD_POST
            )
