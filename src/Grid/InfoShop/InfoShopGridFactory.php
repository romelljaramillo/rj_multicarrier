...
final class InfoShopGridFactory
{
    public function __construct(
        private readonly InfoShopGridDefinitionFactory $gridDefinitionFactory,
    ...
    public function getGrid(InfoShopFilters $filters): Grid
    {
