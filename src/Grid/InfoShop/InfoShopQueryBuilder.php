<?php
/**
 * Doctrine query builder for the InfoShop grid.
 */
...
final class InfoShopQueryBuilder implements DoctrineQueryBuilderInterface
{
    ...
    public function getCountQueryBuilder(SearchCriteriaInterface $searchCriteria)
    {
        $qb = $this->connection->createQueryBuilder()
            ->select('COUNT(DISTINCT i.id_infoshop)')
            ->from($this->dbPrefix . 'rj_multicarrier_infoshop', 'i')
            ->leftJoin('i', $this->dbPrefix . 'rj_multicarrier_infoshop_shop', 'iss', 'iss.id_infoshop = i.id_infoshop')
        ...
        foreach ($filters as $filterName => $filterValue) {
            ...
            switch ($filterName) {
                case 'id_infoshop':
                    ...
                    if (null !== $value) {
                        $qb->andWhere('i.id_infoshop = :id_infoshop')
                            ->setParameter('id_infoshop', (int) $value);
                    }
                    break;
                case 'firstname':
                case 'lastname':
                ...
                case 'ids':
                    ...
                    if (!empty($ids)) {
                        $qb->andWhere('i.id_infoshop IN (:bulk_ids)')
