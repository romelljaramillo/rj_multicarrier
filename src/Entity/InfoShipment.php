...
#[ORM\Entity(repositoryClass: \Roanja\Module\RjMulticarrier\Repository\InfoShipmentRepository::class)]
#[ORM\Table(name: _DB_PREFIX_ . 'rj_multicarrier_info_shipment')]
class InfoShipment
{
    ...
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column(name: 'id_info_shipment', type: 'integer')]
    private ?int $id = null;
     ...
     *
     * @var Collection<int, InfoShipmentShop>
     */
    #[ORM\OneToMany(targetEntity: InfoShipmentShop::class, mappedBy: 'infoShipment')]
    ...
    /**
     * @return Collection<int, InfoShipmentShop>
     */
