...
/**
 * Handler for getting shipments for CSV export.
 */
final class GetShipmentsForExportHandler
{
    ...
    /**
     * @param GetShipmentsForExport $query
     *
     * @return ShipmentView[]
     */
    public function handle(GetShipmentsForExport $query): array
    {
        // Get all non-deleted shipments for export
        $shipments = $this->shipmentRepository->findBy(['deleted' => false]);
