...
INSERT INTO `ps_rj_multicarrier_configuration`
  (`id_configuration`, `firstname`, `lastname`, `company`, `additionalname`, `id_country`, `state`, `city`, `street`, `number`,
   `postcode`, `additionaladdress`, `isbusiness`, `email`, `phone`, `vatnumber`, `label_prefix`, `cod_module`, `active`, `date_add`, `date_upd`)
VALUES
